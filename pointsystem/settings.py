...
SECRET_KEY = '*wi=m3osu5ash(oq-@0zjq#5be*-kmbf#4($prkg1jlpnuirx-'
...
LOGIN_EXEMPT_URLS = (
    r'^profile/login/&',
    r'^profile/logout/&',
    r'^profile/judge/register/&',
    r'^profile/player/register/&',
...
MIDDLEWARE = [
    ...
    'pointsystem.middleware.LoginRequiredMiddleware',
]
